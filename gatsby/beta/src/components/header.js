    ...
    return (
        <header className="bg-white sticky top-0 z-10 laptop:static laptop:top-auto">
            <div className="mx-auto flex flex-wrap laptop:items-center laptop:container">
                ...
                >
                    <AnchorLink
                        className={`button--secondary flex justify-center items-center w-full font-bold text-xl uppercase px-8 py-3 laptop:px-12 laptop:inline-block laptop:w-auto laptop:rounded-lg`}
                        to="#contact"
                        title="Schedule Now">
                        Schedule Now
                    </AnchorLink>
                ...
                <div className="flex-1 flex items-center laptop:flex-initial laptop:justify-end">
                    <a
                        href={`tel:${phone}`}
                        className="button--primary flex justify-center flex-col items-center w-full text-gray-alt font-semibold text-xl px-8 py-3 laptop:px-12 laptop:inline-block laptop:ml-7 laptop:rounded-lg laptop:w-auto"
                    >
