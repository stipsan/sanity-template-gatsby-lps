...
import {handleSubmit, updateField, flashFeedback, hideFeedback, triggerEvent, handleFetchErrors, toggleValidationBox, resetForm} from './form-utils';
            ...
            >
                ...
                <div className={classNames(`justify-center`,{
                    ...
                    <div className={`text-center flex flex-col flex-1`}>
                        ...
                        <div className="relative">
                            <ValidationBox className={this.toggleValidationBox('phone')} message="Phone is invalid" />
                            <TextInput name="phone" placeholder="Phone*" value={this.state.fields.phone.value} updateField={this.updateField} />
                        </div>
                        <div className="relative">
                            <ValidationBox className={this.toggleValidationBox('email')} message="Email is invalid" />
                ...
                <FeedbackBox
                    className={`bottom-14 ${this.state.showFeedback  ? 'inline-block' : 'hidden'} ${this.state.hasErrors ? 'border-red-600' : 'border-green-600' }`}
